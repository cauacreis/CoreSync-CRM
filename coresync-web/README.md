...
- **Física de Arraste Pesada (Drag & Drop)**: O Kanban conta com micro-interações de física brutal. O card original vira um "fantasma" (`opacity-30`, `grayscale`), enquanto o clone flutuante aumenta, ganha uma sombra colossal de 12px e reage à velocidade do mouse, entortando para os lados com uma **física de pêndulo elástica**. As colunas alvo acendem para guiar a queda.
