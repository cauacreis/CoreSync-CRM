    ...
    return (
      <div className="mt-8 border-4 border-zinc-100 bg-zinc-900 p-8 text-center shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
        <h2 className="text-2xl font-black uppercase tracking-tighter text-lime-400">
          Ainda não há dados para os gráficos
        </h2>
        <p className="mt-2 font-bold text-zinc-400">
          Adicione leads ao funil para visualizar os relatórios neo-brutalistas.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
      ...
      <div className="flex flex-col border-4 border-zinc-100 bg-zinc-900 p-6 shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
        <h2 className="mb-6 text-xl font-bold uppercase text-zinc-100">Leads por Status</h2>
        <div className="h-80 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={leadsData}>
              ...
              <YAxis stroke="#ffffff" tick={{ fill: '#ffffff', fontWeight: 'bold' }} tickLine={false} axisLine={{ strokeWidth: 3 }} />
      ...
      <div className="flex flex-col border-4 border-zinc-100 bg-zinc-900 p-6 shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
        <h2 className="mb-6 text-xl font-bold uppercase text-zinc-100">Receita Estimada / Status</h2>
        <div className="h-80 w-full">
          <ResponsiveContainer width="100%" height="100%">
