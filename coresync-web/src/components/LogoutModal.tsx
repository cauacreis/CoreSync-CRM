...
export function LogoutModal({ isOpen, onConfirm, onCancel }: LogoutModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="w-full max-w-sm border-4 border-zinc-950 dark:border-zinc-100 bg-zinc-50 dark:bg-zinc-900 p-8 shadow-[12px_12px_0px_0px_rgba(255,255,255,1)]">
