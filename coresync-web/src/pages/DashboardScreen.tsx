      ...
      <div className="mb-8 flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          <button
            ...
            className="border-4 border-zinc-950 dark:border-zinc-100 bg-purple-400 px-6 py-2 font-bold text-zinc-950 transition-transform active:translate-x-1 active:translate-y-1 hover:bg-purple-300 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]"
          >
            {t('nav.products')}
          </button>
          <button
