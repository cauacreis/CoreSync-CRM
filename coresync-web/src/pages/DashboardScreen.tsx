    ...
    <div className="flex h-full w-full flex-col p-8 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        ...
        <div className="flex flex-col border-4 border-zinc-100 bg-zinc-900 p-6 shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
          <h2 className="text-xl font-bold uppercase text-zinc-400">{t('dashboard.pipeline_value')}</h2>
        ...
        {/* Bloco 2: Revenue Won */}
        <div className="flex flex-col border-4 border-zinc-100 bg-zinc-900 p-6 shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
          <h2 className="text-xl font-bold uppercase text-zinc-400">{t('dashboard.revenue')}</h2>
        ...
        <div className="flex flex-col border-4 border-zinc-100 bg-zinc-900 p-6 shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
          <h2 className="text-xl font-bold uppercase text-zinc-400">{t('dashboard.conversion_rate')}</h2>
